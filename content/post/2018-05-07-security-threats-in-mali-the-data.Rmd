...
It included incidents of various nature, ranging from deadly assaults on civilians by terrorist organizations to clashes between communities or ethnic groups over land or livestock, to confrontations between military forces and armed movements, or between the latter themselves.
...
That was mostly necessary for the information on the victims.
...
### Space
I added this group to enable the mapping of the events, and the computation of region-based statistics (regions, provinces, etc.).
...
I also added two control variables (binary variables: 1/0) to ensure that the sums of the parts (for example count_dead_1 + count_dead_2 + count_dead_3)  - are equal to the totals - nbr_dead.
...
I noticed that the list doe not include the sources.
