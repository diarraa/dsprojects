...
I ended up spending long hours watching Youtube videos (which is now the place I go to learn rather than to find the latest music videos, like I used to few years ago...I miss the good old times) and surfing websites with tutorials on plotly and shiny in R.
...
This project probably brought me closer to all the tools aforementioned than any previous tutorials I took online.
...
Using the same variables, I added an interactive map to represent the yearly count for each in.
